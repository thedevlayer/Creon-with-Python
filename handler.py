...
class access():
    ...
    def login_creon(self):
        ...
        creon.login(self.creon)
        return True

    # 대신증권 접속 여부 확인
    def check_con(self):
        self.con_flag = creon.check_con()
...
class MarketEye():
    ...
    def get_acc_num(self):
        self.acc_num = creon.get_user_info(0, 0)
        return self.acc_num
...
class Account_list():
    ...
    def get_account_list(self):
        ...
        self.balance = creon.get_account_balance()
        ...
        cur_list = creon.curprice_Request(self.codeList)
...
class OHLCV_list():
    ...
    def get_ohlcv_list(self,code, type, num):
        self.ohlcv = pd.DataFrame()
        self.ohlcv = creon.get_ohlcv_info(code, type, num)
        return self.ohlcv
...
class Code_list():
    ...
    def get_code_list(self):
        self.codelist = creon.get_code_list()
